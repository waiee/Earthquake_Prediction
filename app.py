...
def pred():
    ...
    st.write(
        """
        The scatterplots show closely similar patterns to one another, where the points in the training set and the testing set for randomized search lie closer to the line.
        """
    )
